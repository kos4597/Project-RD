...
*/
    ...
    public class WeightedRandomPicker<T>
    {
        ...
        private readonly Dictionary<T, double> itemWeightDic;
        private readonly Dictionary<T, double> normalizeditemWeightDic; // 확률이 정규화된 아이템 목록
        ...
        ***********************************************************************/
        ...
        public WeightedRandomPicker()
        {
            ...
            itemWeightDic = new Dictionary<T, double>();
            normalizeditemWeightDic = new Dictionary<T, double>();
            isDirty = true;
            _sumOfWeights = 0.0;
        }
        ...
        ***********************************************************************/
        ...
        public void Add(params (T item, double weight)[] pairs)
        {
            foreach (var pair in pairs)
            {
                ...
                itemWeightDic.Add(pair.item, pair.weight);
            }
            isDirty = true;
        }
        ...
        ***********************************************************************/
        ...
        public T GetRandomPick(double randomValue)
        {
            ...
            double current = 0.0;
            foreach (var pair in itemWeightDic)
            {
                current += pair.Value;
        ...
        {
            CalculateSumIfDirty();
            return normalizeditemWeightDic[item];
        }

        /// <summary> 아이템 목록 확인(읽기 전용) </summary>
        public ReadOnlyDictionary<T, double> GetItemDictReadonly()
        {
            return new ReadOnlyDictionary<T, double>(itemWeightDic);
        }
        ...
        {
            CalculateSumIfDirty();
            return new ReadOnlyDictionary<T, double>(normalizeditemWeightDic);
        }
        ...
        ***********************************************************************/
        ...
        {
            normalizeditemWeightDic.Clear();
            foreach(var pair in itemWeightDic)
            {
                normalizeditemWeightDic.Add(pair.Key, pair.Value / _sumOfWeights);
            }
        }
        ...
        {
            if(itemWeightDic.ContainsKey(item))
